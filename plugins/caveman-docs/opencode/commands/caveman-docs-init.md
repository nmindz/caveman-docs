...
If any check fails: report failing path, do NOT synthesize content. Re-invoke agent after inspecting failure.
...
- No VCS gating. Target can be any directory (git, jj, hg, svn, plain dir)
